...
// Variable für Mediumname und Dichte
var medium = {
    "medium": [{
        "name_medium": "Luft",
        "density_medium": 1.293
    }, {
        "name_medium": "Stickstoff",
        "density_medium": 1.25
    }, {
        "name_medium": "Sauerstoff",
        "density_medium": 1.429
    }, {
        "name_medium": "Erdgas",
        "density_medium": 0.83
    }, {
        "name_medium": "Wasserstoff",
        "density_medium": 0.09
    }, {
        "name_medium": "Argon",
        "density_medium": 1.784
    }, {
        "name_medium": "CO2",
        "density_medium": 1.977
    }, {
        "name_medium": "Methan",
        "density_medium": 0.73
    }, {
        "name_medium": "Ammoniak",
        "density_medium": 0.771
    }, {
        "name_medium": "Helium",
        "density_medium": 0.179
    }]
};
...
// Auswahlliste Medium füllen
function medium_liste() {
    var selectMedium = document.getElementById("MediumListe");
    medium.medium.forEach(function (medium) {
        var opt = document.createElement("option");
        selectMedium.appendChild(opt);
        opt.innerHTML = medium.name_medium;
        opt.value = medium.name_medium;
    });
...
function wasservolumen() {
    ...
    var druck = parseFloat(document.getElementById("Betriebsdruck").value);
    var temperatur = parseFloat(document.getElementById("Betriebstemperatur").value);
    temperatur = temperatur + 273;
    var sMedium = document.getElementById("MediumListe").value;
    var iMedium = document.getElementById("MediumListe").selectedIndex;
    var sDichte = medium.medium[iMedium - 1].density_medium;
    // Wasservolumenberechnen
    var wvolumen = volumen / 519 * Math.sqrt(sDichte * temperatur / druck);
    ...
    var ergebnisVolumen = "<p><h2>Ergebnis der Berechnung</h2></p>" + "Der equivalente Wasservolumenstrom beträgt: " + wvolumen + " m3/h";
